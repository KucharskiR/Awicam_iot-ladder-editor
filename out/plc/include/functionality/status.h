...
// ??
// CONTROLLER_FLAG_FPGA_I2C_QUEUE_EMPTY
// CONTROLLER_FLAG_FPGA_QUEUE_EMPTY
// CONTROLLER_FLAG_FPGA_I2C_RECEIVED_BYTE

// Control flags
#define CONTROL_FLAG_RUN_LD_PROGRAMM 0x00000001
#define CONTROL_FLAG_DISABLE_OUTPUT 0x00000002
#define CONTROL_FLAG_FPGA_CONNECTED 0x00000100
#define CONTROL_FLAG_AP_ENABLED 0x00001000
#define CONTROL_FLAG_STA_ENABLED 0x00002000
