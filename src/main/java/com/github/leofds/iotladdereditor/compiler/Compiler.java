...
//			String command = "cmd /c arduino-cli compile --fqbn esp32:esp32:esp32c3 plc.ino"; // Replace "dir" with your desired command
			// Replace "dir" with your desired command
			String command = "cmd /c arduino-cli compile --fqbn  esp32:esp32:esp32c3:CDCOnBoot=cdc --build-property \"build.extra_flags=-DCORE_DEBUG_LEVEL=5 -DARDUINO_USB_MODE=1 -DARDUINO_USB_CDC_ON_BOOT=1\" plc.ino"; 
